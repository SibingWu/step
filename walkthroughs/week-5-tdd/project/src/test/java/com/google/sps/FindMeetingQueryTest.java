...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredWithWholeDayOptionalAttendee() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void everyAttendeeIsConsideredWithWholeDayOptionalAttendeeWithNonChronologicalEvents() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void justEnoughRoomAndOptionalAttendeeWithNotEnoughRoom() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting.
    //
    // Events  : |--A--|     |----A----|
  ...
  @Test
  public void justEnoughRoomWithOnlyOptionalAttendee() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting.
    //
    // Events  : |--A--|     |----A----|
  ...
  @Test
  public void noGapWithOnlyOptionalAttendee() {
    // Have one person, but make it so that there is not enough room at any point in the day to
    // have the meeting.
    //
    // Events  : |--A-------|-----B----|
